...
Here's a simple sequence within an ideation workshop: work on solutions in small groups > pitch to the room > Troika Consulting > re-work the solution in small groups > pitch again.
  ...
  * The structure has similarities to [ritual dissent](<https://www.cognitive-edge.com/methods/ritual-dissent/>), which is also a good way to get input from the room. Note that ritual dissent is anchored in critique and is better suited for stress-testing or validating an idea, whereas Troika Consulting includes pathways to illuminate new ideas and narratives.
